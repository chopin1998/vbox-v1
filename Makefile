...
TARGET = main
SRC = main.c clock.c
SRC += uart.c uart_process.c util.c disp.c st7735.c bitchar.c gps.c task.c
ASRC = 
OPT = 2
...
CDEBUG = -g$(DEBUG)
CWARN = -Wall -Wstrict-prototypes -Wno-char-subscripts
...
AVRDUDE_FLAGS = $(AVRDUDE_BASIC) $(AVRDUDE_NO_VERIFY) $(AVRDUDE_VERBOSE) $(AVRDUDE_ERASE_COUNTER) -E noreset
